...
[laptop1, ["<t color='#2bf000'>SELECIONAR VISÃO</t>", { { null = execVM "script\uav\drone1\visao.sqf" } remoteExec [ "call" ,0,true]; }, nil , 9 , false , true , "" , "_this distance _target < 2"]] remoteExec ["addaction",-2,true];
