...
[laptop1, ["<t color='#2bf000'>DESCONECTAR DRONE ATAQUE</t>", { { null = execVM "script\uav\drone2\fechar.sqf" } remoteExec [ "call" ,0,true]; }, nil , 10 , false , true , "" , "_this distance _target < 2"]] remoteExec ["addaction",-2,true];
...
[laptop1, ["<t color='#2bf000'>ZOOM</t>", { { null = execVM "script\uav\drone2\select_zoom.sqf" } remoteExec [ "call" ,0,true]; }, nil , 10 , false , true , "" , "_this distance _target < 2"]] remoteExec ["addaction",-2,true];
