...
// ---------------------------------------------------------------------------------------------------------
	...
	_ACHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","O_Plane_CAS_02_F","O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F"];
	_CHPool=	["O_Heli_Attack_02_black_F","O_Heli_Attack_02_F","O_Heli_Light_02_F","O_Heli_Light_02_unarmed_F","O_Heli_Transport_04_covered_F"];
	_stPool=	["LOP_ISTS_OPF_Static_ZU23","LOP_ISTS_OPF_Kord_High"];
...
// ---------------------------------------------------------------------------------------------------------
	...
	_stPool=	["RHS_NSV_TriPod_VDV","rhs_KORD_high_VDV","rhs_Igla_AA_pod_vdv","RHS_ZU23_VDV"];
	_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
	_diverPool= ["O_diver_exp_F","O_diver_F","O_diver_TL_F"];
...
case 26: {// OPFOR SLAMIC STATE
	_InfPool=	["LOP_ISTS_OPF_Infantry_Engineer","LOP_ISTS_OPF_Infantry_Corpsman","LOP_ISTS_OPF_Infantry_TL","LOP_ISTS_OPF_Infantry_GL","LOP_ISTS_OPF_Infantry_AT","LOP_ISTS_OPF_Infantry_Rifleman_3","LOP_ISTS_OPF_Infantry_Rifleman","LOP_ISTS_OPF_Infantry_Rifleman_2","LOP_ISTS_OPF_Infantry_AR_Asst","LOP_ISTS_OPF_Infantry_AR","LOP_ISTS_OPF_Infantry_Marksman"];
	_ArmPool=	["LOP_ISTS_OPF_T72BA","LOP_ISTS_OPF_T55","LOP_ISTS_OPF_M113_W","LOP_ISTS_OPF_BMP1","LOP_ISTS_OPF_T34","LOP_ISTS_OPF_BMP2","LOP_ISTS_OPF_BTR60","LOP_ISTS_OPF_ZSU234"];
	_MotPool=	["LOP_ISTS_OPF_Truck","LOP_ISTS_OPF_Offroad","LOP_ISTS_OPF_M1025_W_Mk19","LOP_ISTS_OPF_Offroad_M2","LOP_ISTS_OPF_M1025_D","LOP_ISTS_OPF_M998_D_4DR","LOP_ISTS_OPF_Landrover","LOP_ISTS_OPF_Landrover_M2","LOP_ISTS_OPF_M1025_W_M2"];
	_ACHPool=	0;
	_CHPool=	0;
	_stPool=	["LOP_ISTS_OPF_Igla_AA_pod","LOP_ISTS_OPF_Static_ZU23","LOP_ISTS_OPF_Kord","LOP_ISTS_OPF_Static_Mk19_TriPod","LOP_ISTS_OPF_Static_SPG9","LOP_ISTS_OPF_Static_M2_MiniTripod","LOP_ISTS_OPF_NSV_TriPod","LOP_ISTS_OPF_Static_M2","LOP_ISTS_OPF_Static_DSHKM"];
	_shipPool=	0;
	_diverPool=	["LOP_IRA_Infantry_Driver"];
	_crewPool= ["LOP_ISTS_OPF_Infantry_Rifleman"];
	_heliCrew=	0;
};
case 27: {// RESERVADO PARA FACÇÃO PERSONALIZADA
	_InfPool=	[]; // UNIDADES DE INFANTARIA
	_ArmPool=	[]; // VEICULOS BLINDADOS
	_MotPool=	[]; // VEICULOS ARMADOS OU DE TRANSPORTE
	_ACHPool=	[]; // HELICOPTEROS ARMADOS
	_CHPool=	[]; // HELICOPTEROS DE TRANSPORTE
	_stPool=	[]; // ARMAS ESTATICAS
	_shipPool=	[]; // BARCOS E VEICULOS AQUATICOS
	_diverPool=	[]; // PILOTOS DE BARCOS
	_crewPool=  []; // MOTORISTAS DE VEICULOS
	_heliCrew=	[]; // PILOTOS DE VEICULOS AÉREOS
};
